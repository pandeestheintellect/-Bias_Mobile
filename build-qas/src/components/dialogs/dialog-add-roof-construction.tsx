...
class DialogAddRoofConstruction extends Component<IProps,{}> {
    state: IState;
    ...
    componentDidMount()
    {
        getBlockDetail(AssessmentTypes.RoofConsctruction,this.onLoadBlockDetail)
    }
    ...
    onCreate=()=>
    {
        ...
        updateBlockDetails(AssessmentTypes.RoofConsctruction,this.state.block);
    ...
    render()
    {
        return(
            ...
            TransitionComponent={DialogTransition} aria-labelledby="form-dialog-title" >
                <DialogTitle id="form-dialog-title" onClose={this.onDialogClose}>Add Roof Construction</DialogTitle>
                <DialogContent>
...
export default DialogAddRoofConstruction;