...
class DialogAddExternalWall extends Component<IProps,{}> {
    state: IState;
    ...
    componentDidMount()
    {
        getBlockDetail(AssessmentTypes.ExternalWall,this.onLoadBlockDetail)
    }
    ...
    onCreate=()=>
    {
        ...
        updateBlockDetails(AssessmentTypes.ExternalWall,this.state.block);
    ...
    render()
    {
        return(
            ...
            TransitionComponent={DialogTransition} aria-labelledby="form-dialog-title" >
                <DialogTitle id="form-dialog-title" onClose={this.onDialogClose}>Add External Wall</DialogTitle>
                <DialogContent>
...
export default DialogAddExternalWall;